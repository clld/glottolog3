    ...
    <div class="span10 offset1">
        ...
        <%util:section title="Principles" prefix="">
            <p>
                ...
                ${u.format_comment(request, """Elsewhere there are extensive lists of whistled languages (**hh:h:Meyer:Whistled:2015**, **hh:h:BusnelClasse:Whistled**, **hh:e:Harrisson:Borneo-Nomads**, **hh:h:Thierry:Siffles**, **hh:hld:Kouneli:Whistled-Greek**), initiation languages (**hh:ld:Ngonga-ke-Mbembe:Initiatique-Ohendo**, **hh:h:James:Speech-Surrogates**, **hh:h:Storch:Atlantic-Secret**, **hh:typ:Monino:Labi**, ritual languages **hh:ld:Brindle:Kiliji**, **hh:typ:Reinohl:Igu**, **hh:es:Moser:Ngoni**:130), secret languages (**hh:ld:Dugast:Njoya**,**hh:s:Ittman:Nixenkultbundes**,**hh:w:Beaujard:Arabico-Malgache**, **hh:ldsoc:Berjaoui:Amazigh-Secret**, **hh:soc:Berjaoui:Moroccan**, **hh:s:Leiris:Dogons**, **hh:hvld:Leslau:Ethiopian-Argots**, **hh:h:Debrunner:Vergessene-Togorestvolkern**, **hh:hw:Thomas:Southern-Nigeria**, **hh:h:James:Speech-Surrogates**) and drummed languages (**hh:ld:Betz:Trommelsprache-Duala**, **hh:ld:Carrington:Gong**, **hh:ld:Arom:Tambourine-Banda-Linda**, **hh:ld:Seifart:Bora-Drum**, **hh:typ:Stern:Drum**, **hh:ld:Westermann:Zeichensprache-Ewe**, **hh:ld:Eze:Igbo-Oja**, **hh:ld:Zemp:Kwoma**, **hh:ld:Aitken:Drum**, **hh:h:James:Speech-Surrogates**).""")|n}
                <!--l. 86--></p>
        </%util:section>
...
improvement.''')|n}
        ...
        <%util:section title="Acknowledgements" prefix="">
            ...
            <ul class="itemize1">
                ...
                <li class="itemize">To Daniel Ross for help with access to various valuable documents</li>

...
<div class="well">
    ...
    <% drepo = request.registry.settings['clld.github_repos_data'] %>
        <p><a href="https://github.com">GitHub</a> users can also create and discuss bug reports using the following
            <strong>issue trackers</strong>:
        <ul>
            <li><a href="https://github.com/${drepo}/issues">${drepo}/issues</a> for errata on languoids &amp;
                references
            </li>
            <li><a href="https://github.com/${srepo}/issues">${srepo}/issues</a> for problems with the software
                running this site
            </li>
        </ul>
    % endif
